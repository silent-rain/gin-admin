...
type DictService interface {
	List(ctx *gin.Context, req dto.QueryDictReq) ([]model.Dict, int64, error)
	Add(ctx *gin.Context, bean model.Dict) (uint, error)
	Update(ctx *gin.Context, bean model.Dict) (int64, error)
