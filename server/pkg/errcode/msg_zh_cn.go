...
var MsgZHCN = map[ErrorCode]error{
	...
	RedisUnknownClientError: errors.New("redis 未知客户端"),
	...
	ApiHttpTokenPassphraseError:       errors.New("令牌口令错误"),
	ApiHttpTokenInvalidError:          errors.New("无效API令牌"),
	ApiHttpTokenMethodPermissionError: errors.New("没有该资源的操作权限"),
	// 系统管理
