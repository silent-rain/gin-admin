...
var MsgZHCN = map[ErrorCode]error{
	...
	DBUpsertError:            errors.New("数据插入或更新失败"),
	...
	RedisDelKeyError:         errors.New("redis 删除 KEY 失败"),
	RedisIncrKeyError:        errors.New("redis 自增 KEY 值失败"),
	RedisDecrKeyError:        errors.New("redis 自减 KEY 值失败"),
	RedisTTLGetKeyError:      errors.New("redis 查看 Key 剩余的过期时间失败"),
	RedisSetKeyExpireError:   errors.New("redis 设置 key 的过期时间失败"),
	RedisSetKeyExpireAtError: errors.New("redis 设置 key 的过期时间戳失败"),
	RedisGetKeyExistsError:   errors.New("redis 查看一个或多个 KEY 是否存在异常"),
	// Cache 内部缓存
