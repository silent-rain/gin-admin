...
CREATE TABLE `perm_menu` (
  ...
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=137 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='角色菜单关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `perm_user_api_token` (
  ...
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户API接口Token令牌表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `perm_user_api_token` VALUES (1,20,'23dfb2f62e9b55731d34d808eb8575f4','xxx','GET;POST;DELETE;PUT','xx',0,'2023-03-09 22:18:36','2023-03-09 22:39:06'),(4,32,'bf07b991433d2d835472f44078b356bc','手打','POST','',1,'2023-03-09 22:39:04','2023-03-09 22:39:04'),(5,20,'96f4705255f8a21e614f2a17cf76a27e','xxx','GET;POST;DELETE;PUT','xx',0,'2023-03-09 22:51:11','2023-03-09 22:51:11');
...
CREATE TABLE `sys_config` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='应用配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_config` VALUES (1,NULL,'系统配置','system','',1,'系统配置',1,'2023-02-14 22:17:20','2023-02-25 21:01:44'),(2,1,'应用名称','sys_app_name','后台管理系统',1,'',1,'2023-02-14 22:38:32','2023-02-19 23:37:26'),(3,1,'系统邮箱配置','sys_email','{}',1,'',1,'2023-02-19 23:35:23','2023-02-19 23:35:23'),(4,NULL,'网站配置','website','',1,'网站全局配置',1,'2023-02-25 20:32:41','2023-02-25 20:32:41'),(5,4,'网站全称','website_title','后台管理系统',1,'',1,'2023-02-25 20:33:49','2023-03-08 22:22:45'),(6,4,'网站简称','website_title_brief','基于Gin+Vue后台开发框架',1,'',1,'2023-02-25 20:34:48','2023-03-08 22:22:45'),(11,4,'网站LOGO','website_logo','/upload/images/2023-02-26/c3c9bfd0153679db77deec116aad3aa8.ico',1,'',1,'2023-02-25 20:50:14','2023-03-08 22:22:45'),(12,4,'网站SEO标题','website_seo_title','基于Go语言Gin、Vue、MySQL敏捷开发框架',1,'',1,'2023-02-25 20:51:16','2023-03-08 22:22:45'),(13,4,'网站SEO描述','website_seo_desc','基于Go语言Gin、Vue、MySQL等框架打造的组件式敏捷开发框架，简化开发，提升开发效率！！',1,'',1,'2023-02-25 20:51:38','2023-03-08 22:22:45'),(14,4,'网站版权信息','website_copyright','网站版权信息',1,'',1,'2023-02-25 20:52:14','2023-03-08 22:22:45'),(15,4,'网站关键词','website_keywords','go,Gin, vue,MySQL',1,'使用英文逗号\',\'',1,'2023-02-25 20:53:09','2023-03-08 22:22:45'),(16,4,'网站描述','website_description','基于Go语言Gin、Vue、MySQL等框架打造的组件式敏捷开发框架，简化开发，提升开发效率！！',1,'',1,'2023-02-25 20:53:42','2023-03-08 22:22:45'),(17,4,'公司地址','website_company_address','公司地址2',1,'',1,'2023-02-25 20:54:34','2023-03-08 22:22:45'),(18,4,'网站电话','website_phone','网站电话',1,'',1,'2023-02-25 20:54:57','2023-03-08 22:22:45'),(19,4,'网站邮箱','website_email','silent_rains@163.com',1,'',1,'2023-02-25 20:55:12','2023-03-08 22:22:45'),(20,4,'网站QQ','website_qq','2367221387',1,'',1,'2023-02-25 20:56:11','2023-03-08 22:22:45'),(21,4,'网站备案号','website_filing_number','网站备案号',1,'',1,'2023-02-25 20:58:28','2023-03-08 22:22:45'),(22,4,'网站宣传片','website_propaganda','[{\"name\":\"合约.png\",\"url\":\"/upload/images/2023-02-26/69aa018dd7a362e0db00cdd51bc3e7d0.png\"},{\"name\":\"f778738c-e4f8-4870-b634-56703b4acafe.gif\",\"url\":\"/upload/images/2023-02-26/46ba34c2b7de1729b5f7ba9b80ab6794.gif\"}]',1,'',1,'2023-02-25 21:06:14','2023-03-08 22:22:45'),(23,4,'网站标签','website_tags','test',1,'',1,'2023-02-25 21:06:41','2023-03-08 22:22:45'),(24,4,'网站开发者','website_anthor','silent-rain,silent_rains@163.com',1,'',1,'2023-03-08 23:26:12','2023-03-08 23:26:12');
...
CREATE TABLE `sys_user_login` (
  ...
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户登录表-用于登录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-03-09 22:53:02
