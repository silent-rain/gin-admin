...
CREATE TABLE `api_token` (
  ...
  CONSTRAINT `api_token_user_id` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `sys_config` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='应用配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_config` VALUES (1,NULL,'系统配置','system','',1,'系统配置',1,'2023-02-14 22:17:20','2023-02-25 21:01:44'),(2,1,'应用名称','sys_app_name','后台管理系统',1,'',1,'2023-02-14 22:38:32','2023-02-19 23:37:26'),(3,1,'系统邮箱配置','sys_email','{}',1,'',1,'2023-02-19 23:35:23','2023-02-19 23:35:23'),(4,NULL,'网站配置','website','',1,'网站全局配置',1,'2023-02-25 20:32:41','2023-02-25 20:32:41'),(5,4,'网站全称','website_title','后台管理系统',1,'',1,'2023-02-25 20:33:49','2023-02-26 15:23:00'),(6,4,'网站简称','website_title_brief','基于Gin+Vue后台开发框架',1,'',1,'2023-02-25 20:34:48','2023-02-26 15:23:00'),(11,4,'网站LOGO','website_logo','/upload/images/2023-02-26/c3c9bfd0153679db77deec116aad3aa8.ico',1,'',1,'2023-02-25 20:50:14','2023-02-26 15:23:00'),(12,4,'网站SEO标题','website_seo_title','基于Go语言Gin、Vue、MySQL敏捷开发框架',1,'',1,'2023-02-25 20:51:16','2023-02-26 15:23:00'),(13,4,'网站SEO描述','website_seo_desc','基于Go语言Gin、Vue、MySQL等框架打造的组件式敏捷开发框架，简化开发，提升开发效率！！',1,'',1,'2023-02-25 20:51:38','2023-02-26 15:23:00'),(14,4,'网站版权信息','website_copyright','网站版权信息',1,'',1,'2023-02-25 20:52:14','2023-02-26 15:23:00'),(15,4,'网站关键词','website_keywords','go,Gin, vue,MySQL',1,'使用英文逗号\',\'',1,'2023-02-25 20:53:09','2023-02-26 15:23:00'),(16,4,'网站描述','website_description','基于Go语言Gin、Vue、MySQL等框架打造的组件式敏捷开发框架，简化开发，提升开发效率！！',1,'',1,'2023-02-25 20:53:42','2023-02-26 15:23:00'),(17,4,'公司地址','website_company_address','公司地址',1,'',1,'2023-02-25 20:54:34','2023-02-26 15:23:00'),(18,4,'网站电话','website_phone','网站电话',1,'',1,'2023-02-25 20:54:57','2023-02-26 15:23:00'),(19,4,'网站邮箱','website_email','silent_rains@163.com',1,'',1,'2023-02-25 20:55:12','2023-02-26 15:23:00'),(20,4,'网站QQ','website_qq','2367221387',1,'',1,'2023-02-25 20:56:11','2023-02-26 15:23:00'),(21,4,'网站备案号','website_filing_number','网站备案号',1,'',1,'2023-02-25 20:58:28','2023-02-26 15:23:00'),(22,4,'网站宣传片','website_propaganda','[{\"name\":\"合约.png\",\"url\":\"/upload/images/2023-02-26/69aa018dd7a362e0db00cdd51bc3e7d0.png\"},{\"name\":\"f778738c-e4f8-4870-b634-56703b4acafe.gif\",\"url\":\"/upload/images/2023-02-26/46ba34c2b7de1729b5f7ba9b80ab6794.gif\"}]',1,'',1,'2023-02-25 21:06:14','2023-02-26 15:23:00'),(23,4,'网站标签','website_tags','test',1,'',1,'2023-02-25 21:06:41','2023-02-26 15:23:00');
/*!40000 ALTER TABLE `sys_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sys_http_log`
--

DROP TABLE IF EXISTS `sys_http_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `sys_http_log`
--

LOCK TABLES `sys_http_log` WRITE;
/*!40000 ALTER TABLE `sys_http_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_http_log` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sys_menu` (
  ...
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'管理员',1,'',1,'2023-02-01 22:39:38','2023-02-01 22:41:48'),(2,'普通用户',1,'',1,'2023-02-01 22:41:58','2023-02-25 14:24:40'),(3,'xxxx',1,'',1,'2023-02-01 22:42:10','2023-02-25 14:24:16'),(11,'xxx12234',1,'',1,'2023-02-01 23:13:18','2023-02-12 21:46:12'),(13,'xxx',1,'',1,'2023-02-12 21:47:03','2023-02-12 21:47:03'),(14,'test22',1,'',0,'2023-02-22 20:29:15','2023-02-22 21:08:06');
...
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='角色菜单关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `sys_system_log`
--

LOCK TABLES `sys_system_log` WRITE;
/*!40000 ALTER TABLE `sys_system_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_system_log` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sys_web_log`
--

LOCK TABLES `sys_web_log` WRITE;
/*!40000 ALTER TABLE `sys_web_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_web_log` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-02-26 22:27:56
