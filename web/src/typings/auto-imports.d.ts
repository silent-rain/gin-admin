...
declare global {
  ...
  const captchaVerify: typeof import('../api/system/user')['captchaVerify']
  ...
  const login: typeof import('../api/system/user')['login']
  const logout: typeof import('../api/system/user')['logout']
