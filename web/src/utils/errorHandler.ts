...
// vue 警告监听
export async function warnHandler(msg: any, vm: any, trace: string) {
  console.warn(msg)
  console.warn(trace)
  addWebCodeLog({
    level: 'WARN',
 ...
 */
export async function errorHandler(msg: any, vm: any, trace: string) {
  console.error(msg)
  console.error(trace)
  addWebCodeLog({
    level: 'ERROR',
 ...
 * error – 这是被抛出的错误对象。
 */
export async function onerrorHandler(message: string | Event, source?: string, lineno?: number, colno?: number, error?: any) {
