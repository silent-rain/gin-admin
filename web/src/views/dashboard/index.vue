...
<template>
  <div class="scroll-y">
    <div v-lang class="mt-10px mb-10px font-bold">
      switch theme
    </div>
    <el-button @click="setTheme('base-theme')">
      base-theme(default)
    </el-button>
    <el-button @click="setTheme('lighting-theme')">
      lighting-theme
    </el-button>
    <el-button @click="setTheme('china-red')">
      china-red(default)
    </el-button>
    <el-button @click="setTheme('dark')">
      dark-theme
    </el-button>
    ...
    <el-button @click="setSize('large')">
      large
    </el-button>
    <el-button @click="setSize('default')">
      default
    </el-button>
    <el-button @click="setSize('small')">
      small
    </el-button>
    ...
    <el-button @click="changeLanguage('en')">
      en
    </el-button>
    <el-button @click="changeLanguage('zh')">
      zh
    </el-button>

    <!-- example components -->
    <div v-lang class="mb-10px font-bold mt-20px">
      Button Group
    </div>
