...
<template>
  <div class="scroll-y">
    <div class="mt-20px mb-5px font-bold">
    ...
    <el-button type="primary" @click="normalError">
      normalError
    </el-button>
    ...
    <el-button type="primary" @click="req404">
      req404
    </el-button>
    <!-- resource load error   -->
    <div class="mt-20px mb-5px font-bold">
    ...
    <el-button type="primary" @click="errorLogImg">
      imageLoadError
    </el-button>
