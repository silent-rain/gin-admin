...
// 取消用户编辑
function handleUserCancelEdit() {
  emits('update:data', { ...state.dataRaw })
  state.userFormEdit = false
}

// 提交用户编辑
async function handleUserSubmit(formEl: FormInstance | undefined) {
  if (!formEl)
    return
      ...
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item label="性别" prop="gender">
            ...
            <template v-else>
              <el-tag v-if="props.data.gender === 0" type="info">
                保密
              </el-tag>
